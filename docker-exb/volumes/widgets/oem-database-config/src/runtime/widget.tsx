...
/**
 * This widget allows users to update the database for the OEM dashboard by adding Layers,
 * deleting Layers, and deleting Templates. Add Template functionality is in the OEM dashboard itself.
 */
